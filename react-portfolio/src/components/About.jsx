  ...
  <div className="container">
      <div className="about-content">
        ...
        <div className="about-text">
          <h2>About Me</h2>
          <p>I'm Diojeh, a full-stack developer focused on building modern, responsive, and user-friendly web applications. I work with React, HTML, CSS, and other technologies to turn ideas into functional digital experiences. I am passionate about continuous learning and contributing to meaningful projects.</p>
          ...
          <div className="about-social-links">
            <a href="https://github.com/doj1666" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="social-icon">
            ...
            <a href="https://www.facebook.com/diojehmer.villaluna.5" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="social-icon">
